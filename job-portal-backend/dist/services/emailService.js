...
exports.sendNewApplicationNotification = exports.sendContactFormEmail = exports.sendPasswordResetEmail = exports.sendNewJobAlertEmail = exports.sendApplicationStatusEmail = exports.sendWelcomeEmail = exports.sendEmail = exports.testEmailConfig = void 0;
...
const sendWelcomeEmail = async (email, name) => {
  ...
  `;
    await (0, exports.sendEmail)(email, 'Welcome to Job Portal! 🎉', html);
};
exports.sendWelcomeEmail = sendWelcomeEmail;
// Application Status Update Email
const sendApplicationStatusEmail = async (email, userName, jobTitle, status, companyName, message) => {
    const statusColors = {
        Pending: '#f59e0b',
        Reviewed: '#3b82f6',
        Shortlisted: '#8b5cf6',
  ...
  `;
    await (0, exports.sendEmail)(email, `Application Status: ${status} - ${jobTitle}`, html);
};
exports.sendApplicationStatusEmail = sendApplicationStatusEmail;
// New Job Alert Email
const sendNewJobAlertEmail = async (email, userName, jobs) => {
    const jobsList = jobs
        .map((job) => `
  ...
  `;
    await (0, exports.sendEmail)(email, `🔔 ${jobs.length} New Job${jobs.length > 1 ? 's' : ''} Alert`, html);
};
...
const sendPasswordResetEmail = async (email, userName, resetToken) => {
  ...
  `;
    await (0, exports.sendEmail)(email, 'Password Reset Request - Job Portal', html);
};
...
const sendContactFormEmail = async (name, email, subject, message) => {
  ...
  `;
    await (0, exports.sendEmail)(process.env.EMAIL_USER || 'admin@jobportal.com', `Contact Form: ${subject}`, html);
};
exports.sendContactFormEmail = sendContactFormEmail;
// New Application Notification for Employer
const sendNewApplicationNotification = async (employerEmail, employerName, jobTitle, applicantName, applicationId) => {
    const html = `
    <!DOCTYPE html>
    <html>
    <head>
  ...
  `;
    await (0, exports.sendEmail)(employerEmail, `New Application for ${jobTitle}`, html);
};
exports.sendNewApplicationNotification = sendNewApplicationNotification;
...
exports.default = {
    ...
    sendNewJobAlertEmail: exports.sendNewJobAlertEmail,
    sendPasswordResetEmail: exports.sendPasswordResetEmail,
    sendContactFormEmail: exports.sendContactFormEmail,
    sendNewApplicationNotification: exports.sendNewApplicationNotification,
};
