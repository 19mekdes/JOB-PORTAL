...
exports.getJobFilters = exports.toggleJobStatus = exports.getRecommendedJobs = exports.getJobsByLocation = exports.getJobsByIndustry = exports.searchJobs = exports.getJobApplications = exports.getJobStats = exports.getEmployerJobs = exports.deleteJob = exports.updateJob = exports.getJobById = exports.getAllJobs = exports.createJob = void 0;
...
const getAllJobs = async (req, res) => {
    try {
        ...
        const { search, location, industry, employment_type, min_salary, max_salary, is_remote, page = '1', limit = '10', sort = 'recent' } = query;
        const where = {
    ...
    try {
        ...
        const where = {
            ...
            OR: [
                ...
                { employer: { company_name: { contains: q, mode: 'insensitive' } } }
            ]
        };
        const skip = (parseInt(page) - 1) * parseInt(limit);
        const [jobs, total] = await Promise.all([
...
exports.getJobsByIndustry = getJobsByIndustry;
...
exports.getJobsByLocation = getJobsByLocation;
...
exports.getJobFilters = getJobFilters;
