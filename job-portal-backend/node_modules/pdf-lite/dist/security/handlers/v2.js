...
export class PdfV2SecurityHandler extends PdfV1SecurityHandler {
    ...
    async computeOwnerKey() {
        return await computeOValueRc4_128(this.ownerPassword ?? this.password, this.password);
    }
    /**
    ...
    async computeUserKey() {
        ...
        return await computeUValueRc4_128(this.password, this.ownerKey, this.permissions, this.documentId.items[0].bytes, this.encryptMetadata, this.getRevision());
    }
    /**
    ...
    async recoverUserPassword(ownerPassword) {
        ...
        const password = await decryptUserPasswordRc4_128(stringToBytes(ownerPassword), this.ownerKey);
