 ...
 * ```
 */
export declare abstract class PdfCryptFilter {
     ...
     */
    setSecurityHandler(handler: PdfSecurityHandler): void;
    /**
     ...
     */
    abstract getCipher(objectNumber?: number, generationNumber?: number): Promise<Cipher>;
    /**
     ...
     */
    encrypt(data: ByteArray, objectNumber?: number, generationNumber?: number): Promise<ByteArray>;
    /**
     ...
     */
    decrypt(data: ByteArray, objectNumber?: number, generationNumber?: number): Promise<ByteArray>;
    /**
