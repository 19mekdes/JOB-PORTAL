...
export function parseFont(data) {
    ...
    switch (format) {
        ...
        case 'woff2':
            throw new Error('WOFF2 format is not supported by pdf-lite (requires Brotli decompression). Convert the font to WOFF, TTF, or OTF before embedding (for example using fonttools/woff2 or an online converter).');
        default:
 ...
 */
export function isSupportedFontFormat(format) {
