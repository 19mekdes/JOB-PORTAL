 ...
 */
export class WoffParser {
    ttfParser;
    fontData;
    constructor(woffData) {
    ...
    decompressWoff(woffData) {
        ...
        for (let i = 0; i < tables.length; i++) {
            ...
            const compressedData = new Uint8Array(woffData.buffer, woffData.byteOffset + table.woffOffset, table.compLength);
            let tableData;
 ...
 */
export function detectFontFormat(data) {
    if (data.length < 4)
        return 'unknown';
