 ...
 */
export function* bytesToPdfObjects(bytes) {
 ...
 * @returns A generator yielding parsed PDF objects
 */
export function* stringToPdfObjects(str) {
 ...
 * @returns A generator yielding parsed PDF objects
 */
export function* pdfDecoder(input, options) {
 ...
 */
export async function* pdfDecoderAsync(input) {
    const tokeniser = new PdfByteStreamTokeniser();
    const decoder = new PdfDecoder();
