...
import { PdfXRefTable, PdfXRefTableEntry, PdfXRefTableSectionHeader, } from './objects/pdf-xref-table.js';
...
export class PdfDecoder extends IncrementalParser {
    ...
    nextExtraTokens(root = false) {
        ...
        while (true) {
            ...
            if (!(token instanceof PdfWhitespaceToken ||
    ...
    nextTrailer() {
        ...
        const postTokens = this.nextExtraTokens();
        const trailer = new PdfTrailer(dictionary);
    ...
    static isPrimitive(token) {
        return (token instanceof PdfNumberToken ||
