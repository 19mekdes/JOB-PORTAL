...
export async function getFileKey(userPassword, ownerPassword, u, ue, o, oe) {
    ...
    assert(oe.length === 32, 'Invalid OE length. Expected 32 bytes but got ' + oe.length);
    assert(ue.length === 32, 'Invalid UE length. Expected 32 bytes but got ' + ue.length);
    assert(u.length === 48, 'Invalid U length. Expected 48 bytes but got ' + u.length);
    assert(o.length === 48, 'Invalid O length. Expected 48 bytes but got ' + o.length);
    try {
