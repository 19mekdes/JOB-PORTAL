 ...
 */
export const PDF_DOC_ENCODING_TABLE = {
    0x80: '\u2022', // BULLET
    0x81: '\u2020', // DAGGER
    0x82: '\u2021', // DOUBLE DAGGER
 ...
 */
export const UNICODE_TO_PDF_DOC_ENCODING = Object.fromEntries(Object.entries(PDF_DOC_ENCODING_TABLE).map(([byte, char]) => [
    char,
    Number(byte),
]));
/**
 ...
 */
export const PDF_DOC_ENCODING_CHARS = new Set(Object.values(PDF_DOC_ENCODING_TABLE).map((char) => char.charCodeAt(0)));
