 ...
 * ```
 */
export class MacData extends PkiBase {
    mac;
    macSalt;
    iterations;
    constructor(options) {
     ...
     */
    static async create(data, password, iterations, hash = 'SHA-256') {
        ...
        const macKey = await provider.derivePkcs12Key(password, macSalt, iterations, keyLen, 'mac', hash);
