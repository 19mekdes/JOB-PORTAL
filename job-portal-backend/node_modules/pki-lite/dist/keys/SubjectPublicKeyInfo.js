 ...
 * ```
 */
export class SubjectPublicKeyInfo extends PkiBase {
    algorithm;
    subjectPublicKey;
    constructor(options) {
        super();
    ...
    static fromAsn1(asn1) {
        ...
        if (asn1.valueBlock.value.length !== 2) {
            throw new Asn1ParseError('Expected 2 elements in SubjectPublicKeyInfo sequence');
        }
        ...
        const subjectPublicKey = new Uint8Array(subjectPublicKeyBlock.valueBlock.valueHexView);
    ...
    getPublicKey() {
        ...
        else if (this.algorithm.algorithm.toString() === OIDs.RSA.ENCRYPTION) {
