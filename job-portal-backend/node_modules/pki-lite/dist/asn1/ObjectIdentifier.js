 ...
 * ```
 */
export class ObjectIdentifier extends PkiBase {
    /**
    ...
    constructor(options) {
        ...
        const { value } = options;
        if (!value && value !== '') {
            throw new Error('ObjectIdentifier value cannot be undefined or null');
        }
        if (value instanceof ObjectIdentifier) {
            ...
            throw new Error('ObjectIdentifier value must be a string, ObjectIdentifier instance, or object with toString() method');
        }
    }
    /**
    ...
    static fromAsn1(asn1) {
        if (!(asn1 instanceof asn1js.ObjectIdentifier)) {
            throw new Asn1ParseError('Invalid ASN.1 structure: expected OBJECT IDENTIFIER');
        }
        const oidValue = asn1.valueBlock.toString();
        if (!oidValue) {
            throw new Asn1ParseError('Invalid ObjectIdentifier: no value found in ASN.1 structure');
        }
