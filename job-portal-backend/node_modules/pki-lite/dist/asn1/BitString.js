 ...
 * ```
 */
export class BitString extends PkiBase {
    /**
    ...
    static fromAsn1(asn1) {
        if (!(asn1 instanceof asn1js.BitString)) {
            throw new Asn1ParseError('Invalid ASN.1 structure: expected BIT STRING');
        }
        ...
        if (!valueHex) {
            throw new Asn1ParseError('Could not extract value from ASN.1 BIT STRING');
        }
