 ...
 * ```
 */
export class IA5String extends PkiBase {
    bytes;
    constructor(options) {
        super();
        const { value } = options;
    ...
    static fromAsn1(asn1) {
        if (!(asn1 instanceof asn1js.IA5String)) {
            throw new Asn1ParseError('Invalid ASN.1 structure: expected IA5String but got ' +
        ...
        if (!valueHex) {
            throw new Asn1ParseError('Could not extract value from ASN.1 IA5String');
        }
