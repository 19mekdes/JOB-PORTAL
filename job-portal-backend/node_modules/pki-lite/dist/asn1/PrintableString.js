 ...
 * ```
 */
export class PrintableString extends PkiBase {
    bytes;
    constructor(options) {
        super();
        const { value } = options;
    ...
    static fromAsn1(asn1) {
        if (!(asn1 instanceof asn1js.PrintableString)) {
            throw new Asn1ParseError('Invalid ASN.1 structure: expected PrintableString');
        }
        ...
        if (!valueHex) {
            throw new Asn1ParseError('Could not extract value from ASN.1 PrintableString');
        }
