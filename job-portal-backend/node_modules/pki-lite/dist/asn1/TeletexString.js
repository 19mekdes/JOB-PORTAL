 ...
 * ```
 */
export class TeletexString extends PkiBase {
    bytes;
    constructor(options) {
        super();
        const { value } = options;
    ...
    static fromAsn1(asn1) {
        if (!(asn1 instanceof asn1js.TeletexString)) {
            throw new Asn1ParseError('Invalid ASN.1 structure: expected TeletexString');
        }
        ...
        if (!valueHex) {
            throw new Asn1ParseError('Could not extract value from ASN.1 TeletexString');
        }
