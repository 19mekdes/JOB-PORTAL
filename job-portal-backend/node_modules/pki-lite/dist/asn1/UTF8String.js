 ...
 * ```
 */
export class UTF8String extends PkiBase {
    bytes;
    constructor(options) {
        super();
        const { value } = options;
    ...
    static fromAsn1(asn1) {
        if (!(asn1 instanceof asn1js.Utf8String)) {
            throw new Asn1ParseError('Invalid ASN.1 structure: expected UTF8String');
        }
        ...
        if (!valueHex) {
            throw new Asn1ParseError('Could not extract value from ASN.1 UTF8String');
        }
