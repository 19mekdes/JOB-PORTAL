 ...
 * ```
 */
export class Integer extends PkiBase {
    bytes;
    /**
    ...
    static fromAsn1(asn1) {
        if (!(asn1 instanceof asn1js.Integer)) {
            throw new Asn1ParseError('Invalid ASN.1 structure: expected INTEGER');
        }
        return new Integer({
    ...
    toInteger() {
        ...
        try {
            ...
            if (bigValue > Number.MAX_SAFE_INTEGER ||
                ...
                console.warn('Integer value exceeds safe JavaScript number range, precision may be lost');
            }
            return numValue;
        }
        catch (e) {
