 ...
 * ```
 */
export class RevocationInfoArchival extends PkiBase {
    crls;
    ocsps;
    otherRevInfo;
    constructor(options) {
        ...
        for (const element of asn1.valueBlock.value) {
            ...
            if (tagNumber === 0) {
                ...
                if (!(crlSeq instanceof asn1js.Sequence)) {
                    throw new Asn1ParseError('Invalid ASN.1 structure for CRL sequence');
                }
                ...
                if (!(ocspSeq instanceof asn1js.Sequence)) {
                    throw new Asn1ParseError('Invalid ASN.1 structure for OCSP sequence');
                }
                ...
                if (!(oriSeq instanceof asn1js.Sequence)) {
                    throw new Asn1ParseError('Invalid ASN.1 structure for OtherRevInfo sequence');
                }
                for (const oriAsn1 of oriSeq.valueBlock.value) {
                    if (!(oriAsn1 instanceof asn1js.Sequence)) {
                        throw new Asn1ParseError('Invalid ASN.1 structure for OtherRevInfo item');
                    }
