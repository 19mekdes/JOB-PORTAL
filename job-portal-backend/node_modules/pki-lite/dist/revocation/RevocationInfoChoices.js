...
import { asn1js, PkiSet } from '../core/PkiBase.js';
 ...
 * ```
 */
export class RevocationInfoChoices extends PkiSet {
    toAsn1() {
        const values = [];
    ...
    static fromAsn1(asn1) {
        if (!(asn1 instanceof asn1js.Set)) {
            throw new Asn1ParseError('Invalid ASN.1 structure: expected Set for RevocationInfoChoices');
        }
        const choices = asn1.valueBlock.value.map((choiceAsn1) => RevocationInfoChoice.fromAsn1(choiceAsn1));
