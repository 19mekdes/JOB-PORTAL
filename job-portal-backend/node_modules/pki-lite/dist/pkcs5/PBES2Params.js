 ...
 * ```
 */
export class PBES2Params extends PkiBase {
    keyDerivationFunc;
    encryptionScheme;
    constructor(options) {
        super();
    ...
    static fromAsn1(asn1) {
        ...
        const keyDerivationFunc = AlgorithmIdentifier.fromAsn1(asn1.valueBlock.value[0]);
        const encryptionScheme = AlgorithmIdentifier.fromAsn1(asn1.valueBlock.value[1]);
