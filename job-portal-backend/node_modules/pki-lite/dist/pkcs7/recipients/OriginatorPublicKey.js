 ...
 * ```
 */
export class OriginatorPublicKey extends PkiBase {
    algorithm;
    publicKey;
    constructor(options) {
        super();
    ...
    static fromAsn1(asn1) {
        if (!(asn1 instanceof asn1js.Sequence)) {
            throw new Asn1ParseError('Invalid ASN.1 structure: expected Sequence for OriginatorPublicKey');
        }
        ...
        if (!(values[1] instanceof asn1js.BitString)) {
            throw new Asn1ParseError('Invalid ASN.1 structure: expected BitString for publicKey');
        }
