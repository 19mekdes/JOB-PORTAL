import { asn1js, PkiBase, PkiSet } from '../core/PkiBase.js';
 ...
 * ```
 */
class AuthAttributes extends PkiSet {
    static fromAsn1(asn1) {
        if (!(asn1 instanceof asn1js.Set)) {
            throw new Asn1ParseError('Invalid ASN.1 structure: expected Set for AuthAttributes');
        }
        const attributes = asn1.valueBlock.value.map((attrAsn1) => Attribute.fromAsn1(attrAsn1));
 ...
 * ```
 */
class UnauthAttributes extends PkiSet {
    static fromAsn1(asn1) {
        if (!(asn1 instanceof asn1js.Set)) {
            throw new Asn1ParseError('Invalid ASN.1 structure: expected Set for UnauthAttributes');
        }
        const attributes = asn1.valueBlock.value.map((attrAsn1) => Attribute.fromAsn1(attrAsn1));
 ...
 * ```
 */
class RecipientInfos extends PkiSet {
    static fromAsn1(asn1) {
        if (!(asn1 instanceof asn1js.Set)) {
            throw new Asn1ParseError('Invalid ASN.1 structure: expected Set for RecipientInfos');
        }
        const recipients = asn1.valueBlock.value.map((recAsn1) => RecipientInfo.fromAsn1(recAsn1));
 ...
 * ```
 */
export class AuthenticatedData extends PkiBase {
    /**
    ...
    constructor(options) {
        super();
        const { version, recipientInfos, macAlgorithm, encapContentInfo, mac, originatorInfo, digestAlgorithm, authAttrs, unauthAttrs, } = options;
    ...
    static fromAsn1(asn1) {
        ...
        const version = values[currentIndex].valueBlock
            .valueDec;
        currentIndex++;
        ...
        if (currentIndex < values.length &&
            ...
            const originatorInfoAsn1 = values[currentIndex].valueBlock.value[0];
        ...
        if (currentIndex < values.length &&
            ...
            const digestAlgorithmAsn1 = values[currentIndex].valueBlock.value[0];
            digestAlgorithm =
        ...
        if (currentIndex >= values.length) {
            throw new Asn1ParseError('Invalid ASN.1 structure: missing encapsulatedContentInfo');
        }
        const encapContentInfo = EncapsulatedContentInfo.fromAsn1(values[currentIndex]);
        currentIndex++;
        ...
        if (currentIndex < values.length &&
            ...
            const authAttrsAsn1 = values[currentIndex]
                .valueBlock.value[0];
        ...
        if (currentIndex < values.length &&
            ...
            const unauthAttrsAsn1 = values[currentIndex]
                .valueBlock.value[0];
