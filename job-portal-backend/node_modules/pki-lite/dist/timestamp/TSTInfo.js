import { asn1js, PkiBase, derToAsn1, } from '../core/PkiBase.js';
 ...
 */
export class Accuracy extends PkiBase {
        ...
        for (const value of asn1.valueBlock.value) {
            if (value instanceof asn1js.Integer) {
                ...
                if (!(innerValue instanceof asn1js.Integer)) {
                    throw new Asn1ParseError('Invalid ASN.1 structure: expected INTEGER in context-specific tag');
                }
                if (tagNumber === 0) {
 ...
 * @see RFC 3161 Section 2.4.2 - TSTInfo Structure
 */
export class TSTInfo extends PkiBase {
    ...
    constructor(options) {
        super();
        const { version, policy, messageImprint, serialNumber, genTime, accuracy, ordering, nonce, tsa, extensions, } = options;
    ...
    static fromAsn1(asn1) {
        ...
        if (values.length < 5) {
            throw new Asn1ParseError('Invalid ASN.1 structure: expected at least 5 elements');
        }
        // Version
        ...
        if (!(values[1] instanceof asn1js.ObjectIdentifier)) {
            throw new Asn1ParseError('Invalid ASN.1 structure: expected OBJECT IDENTIFIER for policy');
        }
        ...
        if (!(values[4] instanceof asn1js.GeneralizedTime)) {
            throw new Asn1ParseError('Invalid ASN.1 structure: expected GeneralizedTime for genTime');
        }
