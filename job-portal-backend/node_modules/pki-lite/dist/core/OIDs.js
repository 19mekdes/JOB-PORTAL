 ...
 */
export const OIDToFriendlyName = {
    // RSA
    ...
    [OIDs.PKCS12.PBE.SHA1_3DES_3KEY_CBC]: 'PKCS#12 pbeWithSHAAnd3-KeyTripleDES-CBC',
    [OIDs.PKCS12.PBE.SHA1_3DES_2KEY_CBC]: 'PKCS#12 pbeWithSHAAnd2-KeyTripleDES-CBC',
...
export const ShortNameToOID = Object.fromEntries(Object.entries(OIDToShortName).map(([oid, shortName]) => [shortName, oid]));
/**
 ...
 */
export function getOidFriendlyName(oid) {
    return OIDToFriendlyName[oid] || oid;
}
export function getOidShortName(oid) {
    return OIDToShortName[oid] || oid;
}
export function getShortNameOid(shortName) {
