...
import { KeyPairGenOptions } from './crypto/types.js';
/**
...
export declare class KeyGen {
     ...
     * ```
     */
    static generate(options: KeyPairGenOptions): Promise<{
     ...
     * ```
     */
    static generateRsaPair(options?: {
        keySize?: number;
