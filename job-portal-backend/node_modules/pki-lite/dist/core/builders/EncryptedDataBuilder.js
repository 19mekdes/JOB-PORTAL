...
import { AlgorithmIdentifier, ContentEncryptionAlgorithmIdentifier, } from '../../algorithms/AlgorithmIdentifier.js';
import { ObjectIdentifier } from '../../asn1/ObjectIdentifier.js';
import { CONTENT_TYPE_TO_OID } from '../OIDs.js';
/**
 ...
 * ```
 */
export class EncryptedDataBuilder {
    contentType;
    data;
    password;
    salt;
    ...
    async build() {
        ...
        if (this.algorithm) {
            if (this.algorithm instanceof ContentEncryptionAlgorithmIdentifier) {
                encryptionAlgorithm = this.algorithm;
            }
            else {
                encryptionAlgorithm =
                    AlgorithmIdentifier.contentEncryptionAlgorithm(this.algorithm);
            }
        }
        else {
        ...
        const ciphertext = await encryptionAlgorithm.encrypt(this.data, this.password);
