 ...
 */
import { ContentEncryptionAlgorithmIdentifier, KeyEncryptionAlgorithmIdentifier } from '../../algorithms/AlgorithmIdentifier.js';
import { Certificate } from '../../x509/Certificate.js';
import { AsymmetricEncryptionAlgorithmParams, SymmetricEncryptionAlgorithmParams } from '../crypto/types.js';
...
export type EnvelopedDataBuilderRecipient = {
    ...
    keyEncryptionAlgorithm?: AsymmetricEncryptionAlgorithmParams | KeyEncryptionAlgorithmIdentifier;
};
/**
 ...
 */
export declare class EnvelopedDataBuilder implements AsyncBuilder<EnvelopedData> {
    /**
     ...
     */
    static readonly DEFAULT_KEY_ENCRYPTION_ALGORITHM: KeyEncryptionAlgorithmIdentifier;
    ...
    contentEncryptionAlgorithm?: SymmetricEncryptionAlgorithmParams | ContentEncryptionAlgorithmIdentifier;
     ...
     * ```
     */
    setData(data: Uint8Array<ArrayBuffer> | string, contentType?: ObjectIdentifierString): this;
    /**
     ...
     * ```
     */
    setContentEncryptionAlgorithm(algorithm: SymmetricEncryptionAlgorithmParams | ContentEncryptionAlgorithmIdentifier): this;
    /**
