 ...
 * ```
 */
export class TimeStampReqBuilder {
    version = 1;
    messageImprint;
    data;
    ...
    async build() {
        ...
        if (!messageImprint) {
            if (!this.data) {
                throw new Error('Either setData() or setMessageImprint() is required');
            }
            const algorithm = AlgorithmIdentifier.digestAlgorithm(this.hashAlgorithm);
