...
export class PkiBase {
    ...
    parseAs(type) {
        if (type.fromDer) {
            ...
            throw new Asn1ParseError('Invalid type: must implement fromAsn1 or fromDer');
        }
    }
}
/**
 ...
 */
export class PkiArray extends Array {
    maxSize;
    /**
 ...
 */
export class PkiSet extends PkiArray {
    /**
 ...
 */
export class PkiSequence extends PkiArray {
    /**
 ...
 */
export function asn1ToDer(value) {
 ...
 */
export function bytesToHexBytes(bytes) {
 ...
 * @returns The decoded bytes
 */
export function hexBytesToBytes(hex) {
 ...
 */
export function pemToDer(pem, name) {
    const names = Array.isArray(name) ? name : [name];
    for (const n of names) {
        const regex = new RegExp(`-----BEGIN ${n}-----([\\s\\S]+?)-----END ${n}-----`, 'g');
 ...
 */
export function Choice(name, choices) {
    return {
