 ...
 */
export class RSAESOAEPParams extends PkiBase {
    hashAlgorithm;
    maskGenAlgorithm;
    pSourceAlgorithm;
    /**
    ...
    getEffectiveMaskGenAlgorithm() {
        return (this.maskGenAlgorithm || RSAESOAEPParams.defaultMaskGenAlgorithm());
    }
    /**
     * Get effective P source algorithm (either specified or default)
     */
    getEffectivePSourceAlgorithm() {
        return (this.pSourceAlgorithm || RSAESOAEPParams.defaultPSourceAlgorithm());
    }
    /**
