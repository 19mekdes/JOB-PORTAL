 ...
 */
export class RSASSAPSSParams extends PkiBase {
    hashAlgorithm;
    maskGenAlgorithm;
    saltLength;
    trailerField;
    ...
    constructor(options = {}) {
        super();
        const { hashAlgorithm, maskGenAlgorithm, saltLength, trailerField } = options;
    ...
    getEffectiveMaskGenAlgorithm() {
        return (this.maskGenAlgorithm || RSASSAPSSParams.defaultMaskGenAlgorithm());
    }
    /**
