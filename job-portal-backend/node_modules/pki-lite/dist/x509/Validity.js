 ...
 * ```
 */
export class Validity extends PkiBase {
    notBefore;
    notAfter;
    constructor(options) {
        super();
    ...
    static fromAsn1(asn1) {
        ...
        if (notBeforeBlock instanceof asn1js.UTCTime) {
            ...
            throw new Asn1ParseError('Expected UTCTime or GeneralizedTime for notBefore');
        }
        if (notAfterBlock instanceof asn1js.UTCTime) {
            ...
            throw new Asn1ParseError('Expected UTCTime or GeneralizedTime for notAfter');
        }
