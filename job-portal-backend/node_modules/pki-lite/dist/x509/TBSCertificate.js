 ...
 * ```
 */
export class TBSCertificate extends PkiBase {
    version;
    serialNumber;
    signature;
    issuer;
    ...
    toAsn1() {
        const tbsValues = [];
        // Version [0] EXPLICIT
        tbsValues.push(new asn1js.Constructed({
            idBlock: {
        ...
        if (this.issuerUniqueID) {
            tbsValues.push(new asn1js.Primitive({
                idBlock: {
                    tagClass: 3, // CONTEXT-SPECIFIC
                    tagNumber: 1, // [1]
                },
    ...
    static fromAsn1(asn1) {
        ...
        if (firstElement instanceof asn1js.Constructed &&
            ...
            if (!(versionInt instanceof asn1js.Integer)) {
                throw new Asn1ParseError('Invalid TBSCertificate: version must be an INTEGER');
            }
        ...
        if (!(serialAsn1 instanceof asn1js.Integer)) {
            throw new Asn1ParseError('Invalid TBSCertificate: serialNumber must be an INTEGER');
        }
        ...
        if (!(signatureAsn1 instanceof asn1js.Sequence)) {
            throw new Asn1ParseError('Invalid TBSCertificate: signature must be a SEQUENCE');
        }
        ...
        if (!(issuerAsn1 instanceof asn1js.Sequence)) {
            throw new Asn1ParseError('Invalid TBSCertificate: issuer must be a SEQUENCE');
        }
        ...
        if (!(validityAsn1 instanceof asn1js.Sequence)) {
            throw new Asn1ParseError('Invalid TBSCertificate: validity must be a SEQUENCE');
        }
        ...
        if (!(subjectAsn1 instanceof asn1js.Sequence)) {
            throw new Asn1ParseError('Invalid TBSCertificate: subject must be a SEQUENCE');
        }
        ...
        if (!(spkiAsn1 instanceof asn1js.Sequence)) {
            throw new Asn1ParseError('Invalid TBSCertificate: subjectPublicKeyInfo must be a SEQUENCE');
        }
        ...
        if (currentIndex < tbsSequenceValue.length &&
            ...
            const issuerUniqueIDAsn1 = tbsSequenceValue[currentIndex];
            issuerUniqueID = new Uint8Array(issuerUniqueIDAsn1.valueBlock.valueHexView);
            currentIndex++;
        }
        ...
        if (currentIndex < tbsSequenceValue.length &&
            ...
            const subjectUniqueIDAsn1 = tbsSequenceValue[currentIndex];
            subjectUniqueID = new Uint8Array(subjectUniqueIDAsn1.valueBlock.valueHexView);
            currentIndex++;
        }
        ...
        if (currentIndex < tbsSequenceValue.length &&
            ...
            const extensionsContainer = tbsSequenceValue[currentIndex];
            if (extensionsContainer.valueBlock.value.length > 0) {
                ...
                if (extensionsSeq instanceof asn1js.Sequence) {
                    extensions = extensionsSeq.valueBlock.value.map((ext) => Extension.fromAsn1(ext));
                }
            }
        }
