 ...
 * ```
 */
export class CertificateRequest extends PkiBase {
    requestInfo;
    signatureAlgorithm;
    signature;
    constructor(options) {
    ...
    static fromAsn1(asn1) {
        ...
        if (!(requestInfoAsn1 instanceof asn1js.Sequence)) {
            throw new Asn1ParseError('Invalid ASN.1 structure: requestInfo must be a SEQUENCE');
        }
        ...
        if (!(signatureAsn1 instanceof asn1js.BitString)) {
            throw new Asn1ParseError('Invalid ASN.1 structure: signature must be a BIT STRING');
        }
