 ...
 * ```
 */
export class PolicyQualifierInfo extends PkiBase {
    policyQualifierId;
    qualifier;
    constructor(options) {
        super();
    ...
    static fromAsn1(asn1) {
        ...
        if (values.length !== 2) {
            throw new Asn1ParseError('Invalid PolicyQualifierInfo: expected 2 elements');
        }
 ...
 */
export class PolicyInformation extends PkiBase {
    policyIdentifier;
    policyQualifiers;
    constructor(options) {
        super();
    ...
    toAsn1() {
        const values = [this.policyIdentifier.toAsn1()];
    ...
    static fromAsn1(asn1) {
        ...
        if (values.length < 1 || values.length > 2) {
            throw new Asn1ParseError('Invalid PolicyInformation: expected 1 to 2 elements');
        }
        ...
        if (values.length > 1) {
            ...
            if (!(qualifiersAsn1 instanceof asn1js.Sequence)) {
                throw new Asn1ParseError('Invalid PolicyInformation: expected SEQUENCE for policyQualifiers');
            }
