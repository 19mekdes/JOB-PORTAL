...
import { asn1js, Choice, PkiBase, PkiSequence, } from '../core/PkiBase.js';
...
export class AnotherName extends PkiBase {
    typeID;
    value;
    constructor(options) {
        super();
    ...
    static fromAsn1(asn1) {
        ...
        if (!(typeID instanceof asn1js.ObjectIdentifier)) {
            throw new Asn1ParseError('Invalid AnotherName ASN.1 structure: typeID is not an ObjectIdentifier');
        }
        const value = sequence[1];
        return new AnotherName({ typeID: typeID.valueBlock.toString(), value });
    }
}
export class EDIPartyName extends PkiBase {
    nameAssigner;
    partyName;
    constructor(options) {
        super();
    ...
    static fromAsn1(asn1) {
        ...
        if (sequence.length === 2) {
            ...
            if (!(nameAssignerBlock instanceof asn1js.Constructed) ||
                nameAssignerBlock.idBlock.tagClass !== 3 ||
                nameAssignerBlock.idBlock.tagNumber !== 0) {
                throw new Asn1ParseError('Invalid EDIPartyName ASN.1 structure: nameAssigner is not correctly tagged');
            }
            nameAssigner = DirectoryString.fromAsn1(nameAssignerBlock.valueBlock.value[0]);
...
export class directoryName extends Name.RDNSequence {
    ...
    static fromAsn1(asn1) {
        if (!(asn1 instanceof asn1js.Sequence)) {
            throw new Asn1ParseError('Invalid ASN.1 structure: expected Sequence for directoryName');
        }
        return new directoryName(...Name.RDNSequence.fromAsn1(asn1).map((rdn) => rdn));
    }
    static fromName(rdnSequence) {
...
export class ediPartyName extends EDIPartyName {
    ...
    static fromAsn1(asn1) {
        if (!(asn1 instanceof asn1js.Sequence)) {
            throw new Asn1ParseError('Invalid ASN.1 structure: expected Sequence for ediPartyName');
        }
...
export const GeneralName = Choice('GeneralName', {
    ...
    fromAsn1(asn1) {
        if (!(asn1 instanceof asn1js.Constructed) &&
            ...
            throw new Asn1ParseError('Invalid GeneralName ASN.1 structure: not a constructed or primitive type');
        }
        const value = asn1 instanceof asn1js.Constructed
            ? asn1.valueBlock.value[0]
            : asn1;
        switch (asn1.idBlock.tagNumber) {
            case 0:
                return otherName.fromAsn1(value);
            case 1:
                return rfc822Name.fromAsn1(value);
            case 2:
                return dNSName.fromAsn1(value);
            case 3:
                return x400Address.fromAsn1(value);
            case 4:
                return directoryName.fromAsn1(value);
            case 5:
                return ediPartyName.fromAsn1(value);
            case 6:
                return uniformResourceIdentifier.fromAsn1(value);
            case 7:
                return iPAddress.fromAsn1(value);
            case 8:
                return registeredID.fromAsn1(value);
            default:
                throw new Asn1ParseError('Invalid GeneralName ASN.1 structure: unknown tag number ' +
...
export class GeneralNames extends PkiSequence {
    static fromAsn1(asn1) {
        if (asn1 instanceof asn1js.Primitive) {
            return new GeneralNames(GeneralName.fromAsn1(asn1));
        }
        if (!(asn1 instanceof asn1js.Sequence)) {
            throw new Asn1ParseError('Invalid GeneralNames ASN.1 structure. Expected Sequence but got ' +
                asn1.constructor.name);
        }
        return new GeneralNames(...asn1.valueBlock.value.map((v) => GeneralName.fromAsn1(v)));
    }
}
