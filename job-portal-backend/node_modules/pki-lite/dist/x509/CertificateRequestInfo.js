 ...
 * ```
 */
export class CertificateRequestInfo extends PkiBase {
    version;
    subject;
    publicKey;
    attributes;
    ...
    toAsn1() {
        ...
        if (this.attributes && this.attributes.length > 0) {
            const setOfAttributes = new asn1js.Set({
                value: this.attributes.map((attribute) => attribute.toAsn1()),
            });
    ...
    static fromAsn1(asn1) {
        ...
        if (asn1.valueBlock.value.length < 3 ||
            ...
            throw new Asn1ParseError('Invalid ASN.1 structure: expected 3 or 4 elements');
        }
        ...
        const attributesAsn1 = asn1.valueBlock.value.length > 3
        ...
        if (!(subjectAsn1 instanceof asn1js.Sequence)) {
            throw new Asn1ParseError('Invalid ASN.1 structure: subject must be a SEQUENCE');
        }
        if (!(publicKeyAsn1 instanceof asn1js.Sequence)) {
            throw new Asn1ParseError('Invalid ASN.1 structure: publicKey must be a SEQUENCE');
        }
        ...
        if (attributesAsn1) {
            ...
            if (!(attributesAsn1 instanceof asn1js.Constructed) ||
                ...
                throw new Asn1ParseError('Invalid ASN.1 structure: attributes must be [0] context specific');
            }
