 ...
 * ```
 */
export class AttributeCertificateInfoV1 extends PkiBase {
    version;
    subject; // Simplified representation for the subject choice
    issuer; // Simplified representation for GeneralNames
    signature;
    serialNumber;
    validityPeriod;
    attributes;
    ...
    constructor(options) {
        super();
        const { version, subject, issuer, signature, serialNumber, validityPeriod, attributes, issuerUniqueID, extensions, } = options;
