...
import { asn1js, Choice, PkiBase, } from '../../core/PkiBase.js';
 ...
 * ```
 */
export class SigPolicyQualifierInfo extends PkiBase {
    ...
    static fromAsn1(asn1) {
        if (!(asn1 instanceof asn1js.Sequence) ||
            ...
            throw new Asn1ParseError('Expected Sequence with at least 2 elements');
        }
        const sigPolicyQualifierId = ObjectIdentifier.fromAsn1(asn1.valueBlock.value[0]);
 ...
 */
export class OtherHashAlgAndValue extends PkiBase {
    hashAlgorithm;
    hashValue;
    constructor(options) {
        super();
    ...
    static fromAsn1(asn1) {
        ...
        const hashAlgorithm = DigestAlgorithmIdentifier.fromAsn1(asn1.valueBlock.value[0]);
 ...
 */
export class SignaturePolicyId extends PkiBase {
    sigPolicyId;
    sigPolicyHash;
    sigPolicyQualifiers;
    constructor(options) {
    ...
    static fromAsn1(asn1) {
        ...
        const sigPolicyHash = OtherHashAlgAndValue.fromAsn1(asn1.valueBlock.value[1]);
