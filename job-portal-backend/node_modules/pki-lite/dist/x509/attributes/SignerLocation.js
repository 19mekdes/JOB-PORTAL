 ...
 * ```
 */
export class PostalAddress extends PkiSequence {
    maxSize = 6;
    static fromAsn1(asn1) {
        if (!(asn1 instanceof asn1js.Sequence)) {
            throw new Asn1ParseError("Object's schema was not verified against input data for PostalAddress");
        }
        const value = [];
 ...
 * ```
 */
export class SignerLocation extends PkiBase {
    countryName;
    localityName;
    postalAddress;
    constructor(options) {
    ...
    static create(options) {
        ...
        return new SignerLocation({
            ...
            localityName: options.localityName
                ...
                : undefined,
            postalAddress: postalAddress?.map((line) => new DirectoryString.utf8String({ value: line })),
        });
    }
    toAsn1() {
        const values = [];
    ...
    static fromAsn1(asn1) {
        if (!(asn1 instanceof asn1js.Sequence)) {
            throw new Asn1ParseError('Expected ASN.1 Sequence for SignerLocation');
        }
        const value = new SignerLocation();
        for (const element of asn1.valueBlock.value) {
