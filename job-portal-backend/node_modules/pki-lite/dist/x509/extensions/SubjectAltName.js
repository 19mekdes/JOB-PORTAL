...
export class SubjectAltName extends GeneralNames {
    static fromAsn1(asn1) {
        if (!(asn1 instanceof asn1js.Sequence)) {
            throw new Asn1ParseError('Invalid ASN.1 structure: expected Sequence for SubjectAltName');
        }
        const generalNames = asn1.valueBlock.value.map(GeneralName.fromAsn1);
