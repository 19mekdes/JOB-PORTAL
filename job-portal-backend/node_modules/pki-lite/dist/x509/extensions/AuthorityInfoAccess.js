 ...
 * ```
 */
export class AccessDescription extends PkiBase {
    accessMethod;
    accessLocation;
    constructor(options) {
        super();
 ...
 * ```
 */
export class AuthorityInfoAccess extends PkiSequence {
    static fromAsn1(asn1) {
        if (!(asn1 instanceof asn1js.Sequence)) {
            throw new Asn1ParseError('ASN.1 structure should be a sequence');
        }
        return new AuthorityInfoAccess(...asn1.valueBlock.value.map(AccessDescription.fromAsn1));
    }
}
