...
import { Building2, Globe, MapPin, Users, Save, Edit2, Camera, X, Upload } from 'lucide-react'
...
const CompanyProfile: React.FC = () => {
  ...
  const fetchProfile = async () => {
    try {
      ...
      // Dig straight into the profile object sent by the backend wrapper
                ...
                <button
                  ...
                  onClick={async () => {
                    try {
                      ...
                      toast({ variant: "destructive", title: "Error", description: "Failed to reset banner background" })
                    }
                  }}
          ...
          {editing ? (
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <Label htmlFor="location" className="text-gray-700">Headquarters Location</Label>
                  <Input
                    id="location"
              ...
              <div>
                <Label htmlFor="company_size" className="text-gray-700">Workforce Scale Size</Label>
                <Input
                  id="company_size"
